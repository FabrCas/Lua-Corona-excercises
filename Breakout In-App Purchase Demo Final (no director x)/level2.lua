...
function scene:create( event )
	...
	-- completely remove loadlevel2
	composer.removeScene( "loadlevel2" )
...
function scene:show( event )
	...
	print( "level2: show event" )
	
	local backgroundImage = display.newImageRect( "lvl2Screen.png", 480, 320 )
...
function scene:destroy( event )
	...
	print( "destroying level2's view" )
end
