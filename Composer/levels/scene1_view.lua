-- Generated by Level Director X v1.0.0 on Thu Aug 27 20:04:28 2015 --
...
------------------------------------------
	...
	objProps={name='btnNext',objType='LDButton',class='',width=384,height=128,x=320,y=288,xScale=1*1,yScale=1*1,assetName='',
		...
		btnProps={textColorR=255/255,textColorG=255/255,textColorB=255/255,textColorA=255/255,fillType=0,fillAssetName='',fillFrame=0,styleProps	= {cornerRadius=0,strokeWidth=1,strokeColorR=0/255,strokeColorG=0/255,strokeColorB=0/255,strokeColorA=0/255,fillColorR=0/255,fillColorG=0/255,fillColorB=0/255,fillColorA=0/255}},
		}
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='text_2',objType='LDText',class='',width=186,height=58,x=224,y=96,xScale=1*1,yScale=1*1,assetName='',
	...
	objProps={name='title',objType='LDText',class='',width=552,height=38,x=10,y=928,xScale=1*1,yScale=1*1,assetName='',
		rotation=0,enableDrag=false,anchorX=0,anchorY=0,alpha=1,isVisible=true,blendMode='normal',
