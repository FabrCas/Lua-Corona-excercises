-- Generated by Level Director X v1.0.0 on Thu Aug 27 20:04:30 2015 --
...
------------------------------------------
	...
	objProps={name='btnBack',objType='LDButton',class='',width=384,height=128,x=320,y=288,xScale=1*1,yScale=1*1,assetName='',
	...
	objProps={name='text_1',objType='LDText',class='',width=552,height=38,x=10,y=928,xScale=1*1,yScale=1*1,assetName='',
		rotation=0,enableDrag=false,anchorX=0,anchorY=0,alpha=1,isVisible=true,blendMode='normal',
