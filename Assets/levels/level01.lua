-- Generated by Level Director X v1.1.0 on mar set 17 15:00:48 2019 --
...
-----------------------------------
	...
	assets['grass_0']={file ='grass.png',name='grass_0',class='',aX=0.5,aY=0.5,width=480,height=40,frame=0,spriteSheetName='grass',frameCount=1,
		physics={isEnabled=true,source='Asset',bodyType='static',isFixedRotation=false,isSleepingAllowed=false,isSensor=false,linearDamping=0,angularDamping=0,gravityScale=1,isBullet=false,shapes={{bodyShape='Polygon',shape={-240,13,240,12,241,23,-241,22},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},}	}  }
	assets['bird']={file ='bird.png',name='bird',class='',aX=0.5,aY=0.5,width=32,height=40,frame=1,spriteSheetName='bird',frameCount=25,
		...
		physics={isEnabled=true,source='Asset',bodyType='dynamic',isFixedRotation=true,isSleepingAllowed=false,isSensor=false,linearDamping=0,angularDamping=0,gravityScale=1,isBullet=false,shapes={{bodyShape='Polygon',shape={-7,-3,9,-3,11,-1,12,1,12,2,-2,15,-5,15,-13,4},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},}	}  }
	assets['dog_brown_0']={file ='dog_brown.png',name='dog_brown_0',class='',aX=0.5,aY=0.5,width=46,height=27,frame=1,spriteSheetName='dog_brown',frameCount=6,
		...
		physics={isEnabled=true,source='Asset',bodyType='dynamic',isFixedRotation=false,isSleepingAllowed=false,isSensor=false,linearDamping=0,angularDamping=0,gravityScale=1,isBullet=false,shapes={}	}  }
...
------------------------------------------
	...
	objects = {
	{name='sky',objType='LDImage',class='',width=960,height=640,x=480,y=320,xScale=2*1,yScale=2*1,assetName='sky_0',
		userProps = {},
		},
	}
	...
	objects = {
	{name='rigsby',objType='LDImage',class='',width=96,height=64,x=432,y=599,xScale=2.08696*-1,yScale=2.37037*1,assetName='dog_brown_0',
		userProps = {},
		},
	}
	-- add objects to layer
	...
	objects = {
	{name='asset_1',objType='LDImage',class='',width=480,height=40,x=240,y=620,xScale=1*1,yScale=1*1,assetName='grass_0',
		userProps = {},
		},
	{name='asset_2',objType='LDImage',class='',width=480,height=40,x=720,y=620,xScale=1*1,yScale=1*1,assetName='grass_0',
		userProps = {},
		},
	{name='asset_3',objType='LDImage',class='',width=480,height=40,x=1680,y=620,xScale=1*1,yScale=1*1,assetName='grass_0',
		userProps = {},
		},
	{name='asset_4',objType='LDImage',class='',width=480,height=40,x=1200,y=620,xScale=1*1,yScale=1*1,assetName='grass_0',
		userProps = {},
		},
	}
	-- add objects to layer
	...
	objects = {
	{name='palm',objType='LDImage',class='',width=338,height=338,x=1737,y=489,xScale=1*1,yScale=1*1,assetName='palm',
		userProps = {},
		},
	}
	-- add objects to layer
	...
	objects = {
	{name='title',objType='LDText',class='',width=542,height=46,x=13,y=0,xScale=1*1,yScale=1*1,assetName='',
		...
		styleProps={radius=271,cornerRadius=0,strokeWidth=1,strokeColorR=255/255,strokeColorG=255/255,strokeColorB=255/255,strokeColorA=255/255,fillColorR=0/255,fillColorG=0/255,fillColorB=0/255,fillColorA=0/255},
