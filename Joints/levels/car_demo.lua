-- Generated by Level Director X v1.0.0 on Thu Aug 27 20:14:24 2015 --
...
------------------------------------------
	...
	objProps={name='chassis',objType='LDRectangle',class='',width=217.021,height=18.5294,x=1073,y=64,xScale=1*1,yScale=1*1,assetName='',
		...
		physics={isEnabled=true,source='Object',bodyType='dynamic',isFixedRotation=false,isSleepingAllowed=false,isSensor=false,isBullet=false,gravityScale=1,
	...
	objProps={name='front_wheel',objType='LDEllipse',class='',width=61.0096,height=61.0096,x=1001,y=114,xScale=1*1,yScale=1*1,assetName='',
		...
		gradientProps={direction=0,fillColorR=0/255,fillColorG=0/255,fillColorB=0/255,fillColorA=0/255},
		physics={isEnabled=true,source='Object',bodyType='dynamic',isFixedRotation=false,isSleepingAllowed=false,isSensor=false,isBullet=false,gravityScale=1,
		shapes={{bodyShape='Round',shape={ },bounce=0.2,friction=0.3,density=1,radius=30,categoryBits=0,maskBits=0,groupIndex=0 },}}
}	
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='rear_wheel',objType='LDEllipse',class='',width=60.5025,height=60.5025,x=1149,y=114,xScale=1*1,yScale=1*1,assetName='',
	...
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='join_wheels',objType='LDJoint',class='',width=212.402,height=1.28729,x=1114,y=134,xScale=1*1,yScale=1*1,assetName='',
	...
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='support_front',objType='LDJoint',class='',width=88.8228,height=48.2733,x=1064,y=104,xScale=1*1,yScale=1*1,assetName='',
	...
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='support_rear',objType='LDJoint',class='',width=99.7648,height=48.2733,x=1143,y=97,xScale=1*1,yScale=1*1,assetName='',
	...
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='front_shock',objType='LDJoint',class='',width=72,height=50,x=1041,y=86,xScale=1*1,yScale=1*1,assetName='',
	...
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='rear_shock',objType='LDJoint',class='',width=75.3063,height=50.2042,x=1110,y=89,xScale=1*1,yScale=1*1,assetName='',
	...
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='bezier_9',objType='LDBezier',class='',width=0,height=0,x=511,y=448,xScale=1*1,yScale=1*1,assetName='',
		...
		shapes={{bodyShape='Polygon',shape={673,-224,513,-128,513,64,449,128,353,128,225,0,-3,196,65,0,-191,32,-351,128,-479,224,-511,96,-671,-128 },bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0 },}}
}	
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='rope_pivot',objType='LDRectangle',class='',width=32,height=32,x=447,y=16,xScale=1*1,yScale=1*1,assetName='',
	...
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='car_body',objType='LDPolygon',class='',width=0,height=0,x=1089,y=34,xScale=1*1,yScale=1*1,assetName='',
		styleProps={radius=0,cornerRadius=0,strokeWidth=1,strokeColorR=255/255,strokeColorG=255/255,strokeColorB=255/255,strokeColorA=255/255,fillColorR=0/255,fillColorG=0/255,fillColorB=0/255,fillColorA=0/255},
		fillProps ={fillType=0,fillAssetName='',fillFrame=0},
		gradientProps={direction=0,fillColorR=0/255,fillColorG=0/255,fillColorB=0/255,fillColorA=0/255},
		pointProps={outputType='Display',xPoints={-93,-31,48,92},yPoints={ 20,-21,-13,20}},
		physics={isEnabled=true,source='Object',bodyType='dynamic',isFixedRotation=false,isSleepingAllowed=false,isSensor=false,isBullet=false,gravityScale=1,
		shapes={{bodyShape='Polygon',shape={-93,21,-31,-20,48,-12,92,21 },bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0 },}}
}	
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='joint_14',objType='LDJoint',class='',width=77.2372,height=9.01101,x=1034,y=59,xScale=1*1,yScale=1*1,assetName='',
	...
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='ball',objType='LDEllipse',class='',width=30,height=30,x=1,y=83,xScale=1*1,yScale=1*1,assetName='',
		...
		physics={isEnabled=true,source='Object',bodyType='dynamic',isFixedRotation=false,isSleepingAllowed=false,isSensor=false,isBullet=false,gravityScale=1,
		shapes={{bodyShape='Round',shape={ },bounce=0.9,friction=0.3,density=2,radius=15,categoryBits=0,maskBits=0,groupIndex=0 },}}
}	
	obj=instance:createObject(level.layers['main'],objProps,level.assets) 
	objProps={name='rope_joint',objType='LDJoint',class='',width=192,height=91,x=91,y=36,xScale=1*1,yScale=1*1,assetName='',
	...
	objProps={name='title',objType='LDText',class='',width=434,height=38,x=10,y=608,xScale=1*1,yScale=1*1,assetName='',
